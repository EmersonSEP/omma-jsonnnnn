...
cadastrarReceita(
  "Cachorro-quente",
  "simples",
  ["1 queijo", "1 colher de azeite", "Sal a gosto"],
  "Quebre o ovo em um copo americano, jogue sal, e leve à frigideira.",
  "https://google.com",
  false
);

console.log(buscarReceita("Cachorro"));

// console.log(listaDeReceitas);

atualizarReceita(5, {ingredientes:["mortadela, salaminho, presunto e cérebro"], 
preparo:"junte tudo no pão e coma cru", link:"www.cozinhabizarra.com", vegano:false});
